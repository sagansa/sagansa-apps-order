                                                    ...
                                                    <Card onClick={() => router.visit(getProductRoute(product))} elevation={0} sx={{ height: '100%', display: 'flex', flexDirection: 'column', cursor: 'pointer', bgcolor: '#141414', border: '2px solid rgba(244, 67, 54, 0.3)', borderRadius: 2, transition: 'all 0.3s ease', overflow: 'hidden', '&:hover': { borderColor: '#f44336', transform: 'translateY(-4px)', boxShadow: '0 8px 24px rgba(244,67,54,0.2)' } }}>
                                                        ...
                                                        <CardContent sx={{ flexGrow: 1, p: 1.5 }}>
                                                            ...
                                                            <Box sx={{ mt: 'auto' }}>
                                                                ...
                                                                <Button variant="contained" size="small" fullWidth disabled={product.current_stock === 0} onClick={(e) => { e.stopPropagation(); handleAddToCart(product); }} sx={{ bgcolor: product.current_stock === 0 ? 'rgba(255,255,255,0.1)' : '#f44336', color: product.current_stock === 0 ? 'text.secondary' : '#fff', fontWeight: 'bold', textTransform: 'none', '&:hover': product.current_stock === 0 ? {} : { bgcolor: '#d32f2f' } }}>
